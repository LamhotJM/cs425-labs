...
public class Product {
    ...
    public Product(Long productNumber, String name, Double unitPrice, Integer quantityInStock, LocalDate dateSupplied, Supplier supplier) {
        this(null, productNumber, name, unitPrice, quantityInStock, dateSupplied, supplier);
    }
    ...
    public String toString() {
        return new StringJoiner(", ", Product.class.getSimpleName() + "[", "]")
                ...
                .add("supplier=" + supplier.getSupplierId() + " - " + supplier.getSupplierNumber() + " - " + supplier.getName())
                .toString();
    }
